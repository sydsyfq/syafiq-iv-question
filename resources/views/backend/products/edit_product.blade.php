...
<div class="pc-container">
	<div class="pcoded-content">
        ...
        <div class="card">
        	...
        	<div class="card-body">
        		<form method="POST" action="{{ route('update.product', $data->id) }}" enctype="multipart/form-data">
        			@csrf
                    ...
                    <div class="form-group">
                    	...
                    	<input type="number" name="price" class="form-control" value="{{ $data->price }}" step=".01">
                        @error('price')
                        <br> <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
